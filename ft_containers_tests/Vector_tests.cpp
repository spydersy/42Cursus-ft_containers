...
#define TIME_FAC 200000000 // the ft::vector methods can be slower up to std::vector methods * TIME_FAC (MAX 20)
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        // /*------------------------------- test 2: the vector capacity >= size + n ----------------------------------------*/
        {
            ...
            ft_v.insert(ft_v.begin() + 15, 70, "hello");
                std::cerr << " DBG_LINE01 : svsdfdbdfgbbbgsdb | check_condition : " << cond << "************************" << std::endl;
