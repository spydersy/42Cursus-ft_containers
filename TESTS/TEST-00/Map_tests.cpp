...
{    /*------------ std::map ---------*/
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::map<int, std::string> my_m0;


        for (int i = 0; i < 5; ++i)
        {
            m.insert(std::make_pair(13, "HELLO"));
            my_m0.insert(ft::make_pair(13, "HELLO"));
        }

        ft::map<int, std::string>::iterator my_it = my_m0.begin();
        std::map<int, std::string>::iterator it = m.begin();
        EQUAL(it->second.length() == my_it->second.length());
    //std::cout << "======================================================== LEAKS__06__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
    }
    //std::cout << "======================================================== LEAKS__07__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " ++it operator "
              << "] --------------------]\t\t\033[0m";
    {
    //std::cout << "======================================================== LEAKS__08__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
        /*---------------------------------- time limit test --------------------------------------------*/
        {
    ...
    //std::cout << "======================================================== LEAKS__12__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
        }
    //std::cout << "======================================================== LEAKS__13__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
    ++my_it; // I incremented here to make sure that the object changes
        EQUAL(*my_it == *my_it1);
    }
    //std::cout << "======================================================== LEAKS__14__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " --it operator "
              << "] --------------------]\t\t\033[0m";
    {
        /*---------------------------------- time limit test --------------------------------------------*/
        {
            ...
            {
                m.insert(std::make_pair(i, "value"));
                ft_m1.insert(ft::make_pair(i, "value"));
            }
            start = get_time();
            ...
            diff = (diff) ? (diff * TIME_FAC) : TIME_FAC;
            ualarm(diff * 1e3, 0);
            ft::map<int, std::string>::iterator ft_it = --ft_m1.end();
            for (; ft_it != ft_m1.begin(); --ft_it)
                ;
            ualarm(0, 0);
    //std::cout << "======================================================== LEAKS__15__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
        }
        int res(0);
        {
            ...
            ft::map<int, int> m00;
            for (size_t i = 0; i < 5; ++i)
                m00.insert(ft::make_pair(myints[i], i));
            ft::map<int, int>::iterator it = --m00.end();
            for (;; --it)
            {
                if (it == m00.begin())
                {
    ...
    //std::cout << "======================================================== LEAKS__16__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
        }
        --my_it; // I decremented here to make sure that the object changes

    //std::cout << "======================================================== LEAKS__17__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);

        EQUAL(*my_it != *my_it1);
    }
    //std::cout << "======================================================== LEAKS__18__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " it++ operator "
              << "] --------------------]\t\t\033[0m";
    ...
    //std::cout << "======================================================== LEAKS__19__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
    }
    //std::cout << "======================================================== LEAKS__20__ : ========================================================" << std::endl;
    // system("leaks map.out");
    //sleep(10);
...
int main()
{
    ...
    std::cout << YELLOW << "Checking Leaks  ; " << RESET << std::endl << std::endl;
